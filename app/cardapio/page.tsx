...
const categories = ["Todos", "Marmitas", "Bebidas", "Sobremesas"];
            ...
            <motion.button
              ...
              className={`px-6 py-3 rounded-2xl font-semibold transition-all ${
                index === 0
                  ...
                  : "bg-gray-800 text-white hover:bg-verde-marmita"
              }`}
            >
              {category}
            </motion.button>
            ...
            >
              ...
              <div className="p-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-verde-marmita text-white py-3 rounded-xl font-semibold transition-all"
                >
                  Pedir agora
                </motion.button>
              </div>
